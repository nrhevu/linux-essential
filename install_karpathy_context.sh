...
description: Behavioral guidelines to reduce common LLM coding mistakes. Apply these principles to all software development tasks: writing code, fixing bugs, refactoring, adding features, reviewing code, or any coding work. Always active during coding sessions.
---
